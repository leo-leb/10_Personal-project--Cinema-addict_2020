...
export const createMoviePopup = (movie) => {
  const {name, rate, release, genre, duration, poster, descriptionFull, comments, commentsLib, emotionStorage, director, writers, actors, isWatchList, isWatched, isFavorite} = movie;
    ...
    <div class="film-details__bottom-container">
      ...
      <li class="film-details__comment">
        ...
        <div class="film-details__new-comment">
          <div class="film-details__add-emoji-label">${transferEmotion(emotionStorage)}</div>
          <label class="film-details__comment-label">
            <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment">${commentsLib}</textarea>
          </label>
